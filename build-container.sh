...
docker buildx build -t ghcr.io/meggernet/docker/php-fpm:8.4 --build-arg PHP_VERSION=8.4 --build-arg UBUNTU_VERSION=24.04 -f php/8.4.Dockerfile --target=php-fpm php
docker buildx build -t ghcr.io/meggernet/docker/php-cli:8.4 --build-arg PHP_VERSION=8.4 --build-arg UBUNTU_VERSION=24.04 -f php/8.4.Dockerfile --target=php-cli php
docker buildx build -t ghcr.io/meggernet/docker/php-fpm-dev:8.4 --build-arg PHP_VERSION=8.4 --build-arg UBUNTU_VERSION=24.04 -f php/8.4.Dockerfile --target=php-fpm-dev php
docker buildx build -t ghcr.io/meggernet/docker/php-cli-dev:8.4 --build-arg PHP_VERSION=8.4 --build-arg UBUNTU_VERSION=24.04 -f php/8.4.Dockerfile --target=php-cli-dev php
docker buildx build -t ghcr.io/meggernet/docker/php-cron:8.4 --build-arg PHP_VERSION=8.4 --build-arg UBUNTU_VERSION=24.04 -f php/8.4.Dockerfile --target=php-cron php
docker buildx build -t ghcr.io/meggernet/docker/php-cron-dev:8.4 --build-arg PHP_VERSION=8.4 --build-arg UBUNTU_VERSION=24.04 -f php/8.4.Dockerfile --target=php-cron-dev php
docker buildx build -t ghcr.io/meggernet/docker/php-supervisor:8.4 --build-arg PHP_VERSION=8.4 --build-arg UBUNTU_VERSION=24.04 -f php/8.4.Dockerfile --target=php-supervisor php
